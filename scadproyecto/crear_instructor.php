...
<div class="container2">
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">FORMULARIO DE REGISTRO INSTRUCTOR</h2>
        ...
        <center>
            ...
            <div class="datosbasic">
                    ...
                    <m class="astericos">*</m>
                    <p style="text-align: center">Sí Usted aún no tiene un usuario y es instructor, por favor ingrese sus datos aquí</p><br>
              ...
              <ul class="form-section-closed" style="height: 60px;clear:both;" id="section_174">
                  ...
                  <div id="cid_32" class="form-input-wide">
                      ...
                      <center><div class="doc">
                          ...
                          <label class="lgris"><h1></h1></label>                       
                          <input class="form-control" style="text-transform: capitalize;" type="text" name="correo" value="" placeholder=" e-mail: example@example.com" require/>                                        
                        ...
                        <select id="gener" class="form-control" name="sexo" require/>                        
                    ...
                    if ($_SERVER['REQUEST_METHOD']==='POST') { 
                        ...
                        if ($v_ingreso==3){
                            ...
                            $valor1=$fila->id_db;
                                                ...
                                                if($resultado)
                            {                                
                                echo "<script> alert('Su usuario es: ( ".$vcorreo." ) Y su contraseña es:  ( ".$vcontraseña." )'); window.location.href='usua_inst.php' </script>";
